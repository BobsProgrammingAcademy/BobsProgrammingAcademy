...
[![My Skills](https://skillicons.dev/icons?i=js,ts,py,django,react,nextjs,vite,html,css,sass,alpinejs,redux,jest,materialui,tailwind,bootstrap,postgres,sqlite,tensorflow,jenkins,postman,docker,git,github,githubactions,vscode,pycharm,heroku,netlify,vercel)](https://skillicons.dev)
