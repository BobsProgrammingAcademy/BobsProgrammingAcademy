...
[![My Skills](https://skillicons.dev/icons?i=js,ts,nodejs,react,nextjs,redux,materialui,jest,html,css,sass,bootstrap,py,django,sqlite,postgres,tensorflow,postman,vscode,git,github,githubactions,heroku)](https://skillicons.dev)
