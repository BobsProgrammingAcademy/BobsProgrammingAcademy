...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nextjs,nodejs,materialui,html,css,sass,bootstrap,tailwind,py,django,sqlite,postgres,mysql,postman,vscode,git,github,githubactions,webpack,babel,vite,redux,docker,jest,heroku,vercel,aws)](https://skillicons.dev)
