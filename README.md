...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nextjs,vite,alpinejs,redux,jest,materialui,html,css,sass,bootstrap,tailwind,py,django,postgres,sqlite,tensorflow,heroku,git,github,githubactions,postman,vscode)](https://skillicons.dev)
