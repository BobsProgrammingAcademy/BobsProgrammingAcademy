...
[![My Skills](https://skillicons.dev/icons?i=js,ts,nodejs,react,nextjs,alpinejs,vite,redux,materialui,styledcomponents,jest,html,css,sass,bootstrap,tailwind,py,django,postgres,mysql,sqlite,mongodb,tensorflow,postman,vscode,git,github,githubactions,docker,heroku)](https://skillicons.dev)
