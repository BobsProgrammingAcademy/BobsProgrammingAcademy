...
[![My Skills](https://skillicons.dev/icons?i=py,js,ts,django,react,nextjs,vite,redux,jest,html,css,sass,alpinejs,tailwind,bootstrap,materialui,postgres,sqlite,postman,git,github,githubactions,jenkins,heroku,vercel,netlify,docker,tensorflow,vscode,pycharm)](https://skillicons.dev)
