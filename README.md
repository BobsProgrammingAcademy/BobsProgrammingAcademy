...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nextjs,vite,alpinejs,redux,jest,cypress,selenium,materialui,tailwind,bootstrap,html,css,sass,py,django,postgres,sqlite,tensorflow,git,github,githubactions,postman,docker,vscode,heroku,netlify,vercel)](https://skillicons.dev)
