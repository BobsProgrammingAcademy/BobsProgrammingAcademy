...
[![My Skills](https://skillicons.dev/icons?i=js,ts,py,html,css,sass,react,nextjs,vite,alpinejs,redux,jest,cypress,selenium,materialui,tailwind,bootstrap,django,postgres,sqlite,tensorflow,git,github,githubactions,postman,docker,vscode,heroku,netlify,vercel)](https://skillicons.dev)
