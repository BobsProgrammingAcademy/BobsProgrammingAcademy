...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nextjs,materialui,html,css,bootstrap,sass,py,django,postgres,sqlite,tensorflow,vscode,git,postman,selenium,heroku,vercel)](https://skillicons.dev)
