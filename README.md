...
[![My Skills](https://skillicons.dev/icons?i=js,ts,nodejs,react,nextjs,alpinejs,vite,materialui,styledcomponents,html,css,sass,bootstrap,tailwind,py,django,postgres,mysql,sqlite,mongodb,tensorflow,jest,redux,postman,vscode,git,github,githubactions,docker,heroku)](https://skillicons.dev)
